...
const { increaseUserPoints } = require("./points")
...
async function endVoiceSession(guildId, userId, channelId) {
  try {
...
async function recordMediaSubmission(guildId, userId, channelId, messageId, mediaType) {
  try {
...
async function getUserMediaStats(guildId, userId) {
  try {
